...
void startSkærmSetup() {
  ...
  startSkærmMitKnap = new Knap(width/10, height/5*3-width/10, width/5, width/5, color(247, 239, 210), "Min profil", 55*width/1440, color(71, 92, 108), color(71, 92, 108), 0, startSkærm);
